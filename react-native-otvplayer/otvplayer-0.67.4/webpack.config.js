	...
	return [
		{
			...
			output: {
				path: path.resolve(__dirname, "../dist/0.67.4/web"),
				filename: `${sdkJSFilename}.js`,
				libraryTarget: "umd",
				globalObject: "this",
				//clean: true, //removed this code becasuse we need to build code twice //yarn build-web-all // yarn build-web-publish
			},
			module: {
